...
public class AddressServiceImpl implements AddressService{
	...
	public AddressDto getAddressById(Integer addressId) {
		...
		Optional<AddressEntity> addressEntity = Optional.ofNullable(addressRepository.getById(addressId));
		if(addressEntity.isPresent()) {
			returnValue = tempConverter.addressEntityToDto(addressEntity.get());
		}
		return returnValue;
	}
